...
const NewLetter = () => {
  return (
     <div className="flex flex-col items-center w-full max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
      ...
      <Title title='Stay Imspired' subtitle='Join our newsletter and be the first to discover new destinations, exclusive offers, and travel inspiration.'/>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
                   <img src={assets.arrowIcon} className='w-3.5 invert group-hover:translate-x-1 transition-all' alt="" />
                </button>
            </div>
